    ...
    <body style="background-color:#17a2b8" >
        ...
        <div class="container" style="background-color: buttonface">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <form action="statisticm" method="Post" >
                       Tháng: <input  type="text"  aria-label="Search" name="month">
                       Năm:  <input  type="text"  aria-label="Search" name="year">
                        <button type="submit">Search</button>
                    </form>
                    <div class="row">
                            ...
                            <tbody>
                                <c:forEach items="${listOD}" var="o">
                                    <tr>
                                        ...
                                        <td>${o.month}</td>
                                        <td>${o.total}</td>
                                        <td><a href="searchO" class="btn btn-success btn-block" style="width: 100px">xem chi tiết</a></td>
