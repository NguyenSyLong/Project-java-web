                ...
                <div class="pb-5">
                    <div class="container">
                                            ...
                                            <c:forEach items="${list}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        ...
                                                        <a href="prescrip?id=${o.id}"><button class="btnAdd">+</button></a>
                                                    </td>
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Nhập tên khách hàng</div>
                                <form role="form" action="order" method="post">
                                    ...
                                    <div class="form-group">
                                        Order Date <input type="Date" name="ODate" id="last_name" class="form-control input-sm" >
                                    </div>
                                    <input type="submit" value="Kê đơn" class="btn btn-info btn-block">
                                </form>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền sản phẩm</strong><strong>${total}</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Thuế suất(%)</strong><strong>10%</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Thuế giá trị gia tăng</strong><strong>${GTGT}</strong></li>
