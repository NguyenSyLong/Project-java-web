    ...
    <body style="background-color:#17a2b8" >
        ...
        <div class="container" style="background-color: buttonface; width: 500px;margin-bottom:50px ">
            ...
            <div class="panel-body" >
                <form role="form" action="addP" method="post">


                    <div class="form-group">
                        Tên sản phẩm <input type="text" name="Name" id="first_name" class="form-control input-sm" >
                    </div>


                    <div class="form-group">
                        Ngày nhập <input type="Date" name="Date" id="last_name" class="form-control input-sm" >
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                Giá nhập <input type="text" name="IPrice" id="email" class="form-control input-sm" >
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                    ...
                    Thể loại
                    <select name="select" class="form-select" aria-label="Default select example" style="width: 250px">
                    ...
                    <input type="submit" value="Nhập hàng" class="btn btn-info btn-block">
